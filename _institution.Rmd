...
* **Actual price for *your* family**: Go <a href='`r PrependHttpsIfNeeded(most_current_info['Net price calculator web address'])`'>here</a> to see what your family may be asked to pay. It can be MUCH lower than the average price but also higher for some.
