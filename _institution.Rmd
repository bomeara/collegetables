...
#	comparison_df[row_index,1] <- paste0(100*comparison_df[row_index,1],'%')
#}
...
location_summary[nrow(location_summary)+1,] <- c("Location", paste0((paste0(rev(strsplit(as.character(focal_raw['LocaleChar']), ': ')[[1]]), collapse=' ')), ': ',as.character(focal_raw['City']), ', ', as.character(focal_raw['State'][1,1])))
...
location_summary %>% htmlTable::htmlTable(rnames=FALSE)
```
