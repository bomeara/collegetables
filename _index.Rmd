...
if(nrow(all_colleges)>0) {
	...
	#all_colleges <- all_colleges %>% dplyr::select(-UNITID) %>% dplyr::select(-`IPEDS Year`)
}
...
htmltools::tags$script("
  ...
  Reactable.toggleHideColumn('college-list', 'Athletic conference')
  }
")
...
htmltools::tags$script("
	...
	Reactable.toggleHideColumn('college-list', 'Female')
	Reactable.toggleHideColumn('college-list', 'Male ')
	Reactable.toggleHideColumn('college-list', 'American Indian or Alaskan Native')
	Reactable.toggleHideColumn('college-list', 'Asian')
	Reactable.toggleHideColumn('college-list', 'Black or African American')
	Reactable.toggleHideColumn('college-list', 'Hispanic')
	Reactable.toggleHideColumn('college-list', 'Nonresident alien percentage')
	Reactable.toggleHideColumn('college-list', 'Pacific Islander')
	Reactable.toggleHideColumn('college-list', 'White')  }
	Reactable.toggleHideColumn('college-list', 'Two or more races')
")

htmltools::tags$script("
	function toggle_graduation_demo() {
	Reactable.toggleHideColumn('college-list', 'Graduation rate in four years')
	Reactable.toggleHideColumn('college-list', 'Graduation rate in six years')
	Reactable.toggleHideColumn('college-list', 'Graduation rate women')
	Reactable.toggleHideColumn('college-list', 'Graduation rate men')
	Reactable.toggleHideColumn('college-list', 'Graduation rate American Indian or Alaska Native')
	Reactable.toggleHideColumn('college-list', 'Graduation rate Asian')
	Reactable.toggleHideColumn('college-list', 'Graduation rate Black or African American')
	Reactable.toggleHideColumn('college-list', 'Graduation rate Hispanic')
	Reactable.toggleHideColumn('college-list', 'Graduation rate Nonresident alien')
	Reactable.toggleHideColumn('college-list', 'Graduation rate Pacific Islander')
	Reactable.toggleHideColumn('college-list', 'Graduation rate White')
	Reactable.toggleHideColumn('college-list', 'Graduation rate Two or more races')
...
reactable(
  ...
  defaultColDef = colDef(
	filterInput = dataListFilter("college-list"),
	show = FALSE
  ),
  selection = "multiple",
  onClick = "select",
