...
if(nrow(all_colleges)>0) {
	...
	for (college_index in sequence(nrow(all_colleges))) {
		all_colleges$Institution[college_index] <- paste0("<a href='https://collegetables.info/", utils::URLencode(gsub(" ", "", all_colleges$UNITID[college_index])),  ".html'>", all_colleges$Institution[college_index], "</a>")
	}
	...
	Overview <- index_conversions$Rename[index_conversions$Category=="Overview"]

	Finances <- index_conversions$Rename[index_conversions$Category=="Finances"]
	
	Location <- index_conversions$Rename[index_conversions$Category=="Location"]
	
	Admissions <- index_conversions$Rename[index_conversions$Category=="Admissions"]
	
	Outcomes <- index_conversions$Rename[index_conversions$Category=="Outcomes"]
	
	Resources <- index_conversions$Rename[index_conversions$Category=="Resources"]
	
	Student_life <- index_conversions$Rename[index_conversions$Category=="Student life"]
	
	Freshmen_demographics <- index_conversions$Rename[index_conversions$Category=="Freshmen demographics"]
	
	Safety <- index_conversions$Rename[index_conversions$Category=="Safety"]
	
	Revenue_sources <- index_conversions$Rename[index_conversions$Category=="Revenue sources"]
