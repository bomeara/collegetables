...
Misconduct <- c("Liquor discipline per student (3 yr avg)", "Drug discipline per student (3 yr avg)", "Weapon discipline per student (3 yr avg)", "Reported rape per student (3 yr avg)", "Reported fondling per student (3 yr avg)")
