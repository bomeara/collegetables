...
All the fields can be filtered on. For ones with a few options (Yes/No, States, Sector, etc.) you can select from pre-computed selections; for numbers, you can filter by the upper and lower limits; for free text, you can search. For example, "HBCU" in Type will include only historically Black colleges and universities.
