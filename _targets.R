...
list(
  ...
  tar_target(institituion_rmd_change_tracking, "_institution.Rmd", format="file"),
  ...
  tar_target(pages, RenderInstitutionPages(overview, degree_granting_enhanced, maxcount, students_by_state_by_institution, student_demographics, faculty_counts, institituion_rmd_change_tracking, spark_width, spark_height)),
