...
list(
 ...
 tar_target(comparison_table_slow_updating, AppendVaccination(AppendDistanceToMountains(AppendCATravelBan(AppendAAUPCensure(comparison_table_core))))),
 tar_target(comparison_table, ReorderComparisonTable(AppendTransRisk(AppendBiome(AppendAbortion(AppendGunLaws(AppendMarriageRespect(AppendContraceptiveSupport(comparison_table_slow_updating)))))))),
 ...
 tar_target(pages_new, RenderInstitutionPagesNew(comparison_table, fields_and_majors, maxcount=maxcount, CIPS_codes=CIPS_codes, weatherspark=weatherspark, yml=yml, index_table=index_table, life_expectancy=life_expectancy)),
